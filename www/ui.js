...
(function () {
  ...
  var SKINS = [
    ...
    { id: 'lime', name: 'Lime Zest', price: 300, accent: '#a3e635' },
    { id: 'bubblegum', name: 'Bubblegum', price: 350, accent: '#f472b6',
      hull: ['#f9a8d4', '#fdf2f8', '#fce7f3', '#ec4899'],
      window: ['#eff6ff', '#93c5fd', '#1e40af'] },
    { id: 'oceanwave', name: 'Ocean Wave', price: 450, accent: '#0ea5e9',
      accentGradient: ['#22d3ee', '#0ea5e9', '#1e40af'] },
    { id: 'grape', name: 'Neon Grape', price: 500, accent: '#a855f7',
      hull: ['#6d28d9', '#ede9fe', '#c4b5fd', '#4c1d95'] },
    { id: 'sunset', name: 'Sunset Cruiser', price: 550, accent: '#fb923c',
      accentGradient: ['#fbbf24', '#fb923c', '#ec4899'] },
    { id: 'cherrybomb', name: 'Cherry Bomb', price: 650, accent: '#fecdd3',
      hull: ['#991b1b', '#fca5a5', '#ef4444', '#7f1d1d'],
      window: ['#fff1f2', '#fda4af', '#881337'] },
    { id: 'copper', name: 'Copper Punk', price: 800, accent: '#22d3ee',
      hull: ['#92400e', '#fdba74', '#ea580c', '#7c2d12'],
      window: ['#ecfeff', '#67e8f9', '#155e75'] },
    { id: 'cottoncandy', name: 'Cotton Candy', price: 900, accent: '#f9a8d4',
      accentGradient: ['#f9a8d4', '#e9d5ff', '#93c5fd'],
      hull: ['#bfdbfe', '#fdf2f8', '#fce7f3', '#93c5fd'] },
    { id: 'midnightgold', name: 'Midnight Gold', price: 1000, accent: '#fbbf24',
      hull: ['#0f172a', '#475569', '#1e293b', '#020617'],
      window: ['#fefce8', '#fde047', '#713f12'] },
    { id: 'emeraldroyale', name: 'Emerald Royale', price: 1300, accent: '#fbbf24',
      hull: ['#065f46', '#a7f3d0', '#34d399', '#064e3b'],
      window: ['#fefce8', '#fde047', '#713f12'] },
    { id: 'dragonfire', name: 'Dragonfire', price: 1800, accent: '#ef4444',
  ...
  var TRAILS = [
    ...
    { id: 'rosepetal', name: 'Rose Petal', price: 250, colors: ['#fda4af', '#fb7185', '#ffe4e6'] },
    { id: 'bubble', name: 'Bubble Pop', price: 250, colors: ['#f9a8d4', '#fdf2f8', '#f472b6'] },
    { id: 'lemon', name: 'Electric Lemon', price: 300, colors: ['#fde047', '#facc15', '#fef9c3'] },
    { id: 'mint', name: 'Mint Breeze', price: 300, colors: ['#a7f3d0', '#6ee7b7', '#ecfdf5'] },
    { id: 'ember', name: 'Ember Burn', price: 300, colors: ['#f97316', '#fbbf24', '#ef4444'] },
    { id: 'lavender', name: 'Lavender Mist', price: 350, colors: ['#c4b5fd', '#a78bfa', '#ede9fe'] },
    { id: 'goldrush', name: 'Gold Rush', price: 350, colors: ['#fbbf24', '#fde68a', '#b45309'] },
    { id: 'sky', name: 'Sky Stream', price: 350, colors: ['#93c5fd', '#dbeafe', '#60a5fa'] },
    { id: 'frost', name: 'Frost Wake', price: 400, colors: ['#7dd3fc', '#e0f2fe', '#38bdf8'] },
    { id: 'venom', name: 'Venom Stream', price: 400, colors: ['#a3e635', '#4ade80'] },
    { id: 'ocean', name: 'Ocean Spray', price: 450, colors: ['#22d3ee', '#0ea5e9', '#a5f3fc'] },
    { id: 'cherry', name: 'Cherry Fizz', price: 500, colors: ['#ef4444', '#fb7185', '#fecdd3'] },
    { id: 'magma', name: 'Magma Drip', price: 550, colors: ['#dc2626', '#f97316', '#7c2d12'] },
    { id: 'sludge', name: 'Toxic Sludge', price: 550, colors: ['#65a30d', '#a3e635', '#365314'] },
    { id: 'ghost', name: 'Ghost Flame', price: 600, colors: ['#f8fafc', '#cbd5e1', '#e2e8f0'] },
    { id: 'velvet', name: 'Royal Velvet', price: 650, colors: ['#7c3aed', '#a855f7', '#ddd6fe'] },
    { id: 'confetti', name: 'Cosmic Confetti', price: 700, colors: ['#f472b6', '#4ade80', '#60a5fa', '#fbbf24'] },
    { id: 'pulse', name: 'Neon Pulse', price: 750, colors: ['#22d3ee', '#f0fdff'], count: 2 },
    { id: 'stardust', name: 'Stardust', price: 800, colors: ['#fef9c3', '#fde68a', '#ffffff'], count: 2 },
    { id: 'solarwind', name: 'Solar Wind', price: 900, colors: ['#fb923c', '#fff7ed', '#fdba74'], count: 2 },
    { id: 'firework', name: 'Firework Fizz', price: 950,
      colors: ['#f472b6', '#fbbf24', '#4ade80', '#60a5fa', '#ffffff'], count: 2 },
    { id: 'aurorawake', name: 'Aurora Wake', price: 1100, colors: ['#4ade80', '#22d3ee', '#a78bfa'], count: 2 },
    { id: 'comet', name: 'Comet Tail', price: 1250, colors: ['#e0f2fe', '#7dd3fc', '#ffffff'], count: 3 },
