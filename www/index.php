      ...
      <div id="start-screen" class="overlay overlay-start">
        ...
        <div class="menu-planet">
          <svg viewBox="0 0 130 120">
            <defs>
              <radialGradient id="planet-g" cx="35%" cy="30%" r="80%">
                <stop offset="0" stop-color="#a5b4fc"/>
                <stop offset="55%" stop-color="#6366f1"/>
                <stop offset="100%" stop-color="#312e81"/>
              </radialGradient>
            </defs>
            <circle cx="65" cy="60" r="33" fill="url(#planet-g)"/>
            <path d="M34 50 Q65 40 96 50" stroke="rgba(255,255,255,0.16)" fill="none" stroke-width="4"/>
            <path d="M33 66 Q65 76 97 66" stroke="rgba(2,6,23,0.25)" fill="none" stroke-width="5"/>
            <ellipse cx="65" cy="63" rx="57" ry="13" fill="none" stroke="#22d3ee" stroke-width="2.5" opacity="0.45" transform="rotate(-16 65 63)"/>
            <ellipse cx="65" cy="63" rx="48" ry="10" fill="none" stroke="#a5f3fc" stroke-width="1" opacity="0.3" transform="rotate(-16 65 63)"/>
          </svg>
        </div>
        ...
        <div class="panel panel-start">
          ...
          <div id="menu-main" class="menu">
            ...
            <div class="home-stats">
              ...
              <div id="home-pilot-tile" class="home-stat home-stat-pilot">
                <span id="home-pilot" class="home-stat-value home-stat-indigo">GUEST</span>
                <span id="home-rank" class="home-stat-label">Pilot</span>
                <span class="rank-track"><span id="home-rank-fill" class="rank-fill"></span></span>
              </div>
            </div>
